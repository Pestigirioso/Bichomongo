...
public class EspecieDAOMock implements EspecieDAO {
    ...
    static {
        ...
        amarillo.setPeso(69);
        amarillo.setEnergiaInicial(300);
        ...
        turronmon.setEnergiaInicial(5000);
        ...
        fantasmon.setEnergiaInicial(5000);
        ...
        vampiron.setPeso(99);
        vampiron.setEnergiaInicial(5000);
        ...
        fortmon.setPeso(99);
        fortmon.setEnergiaInicial(5000);
        ...
        dientemon.setEnergiaInicial(5000);
    ...
    @Override
    public void actualizar(Especie especie) {DATA.put(especie.getNombre(), especie);}
}
