...
class EspecieDAOTest {
    ...
    @BeforeEach
    void prepare() {
        this.dao = new EspecieDAOHib();
        this.testService = new TestService();

        this.testService.crearEntidad(new Especie(1, "Rojomon", TipoBicho.FUEGO, 180, 75, 100, "/image/rojomon.jpg"));
        this.testService.crearEntidad(new Especie(2, "Amarillomon", TipoBicho.ELECTRICIDAD, 170, 69, 300, "/image/amarillomon.jpg"));
        this.testService.crearEntidad(new Especie(3, "Verdemon", TipoBicho.PLANTA, 150, 55, 5000, "/image/verdemon.jpg"));
        this.testService.crearEntidad(new Especie(4, "Tierramon", TipoBicho.TIERRA, 1050, 99, 5000, "/image/tierramon.jpg"));
        this.testService.crearEntidad(new Especie(5, "Fantasmon", TipoBicho.AIRE, 1050, 99, 5000, "/image/fantasmon.jpg"));
        this.testService.crearEntidad(new Especie(6, "Vampiron", TipoBicho.AIRE, 1050, 99, 5000, "/image/vampiromon.jpg"));
        this.testService.crearEntidad(new Especie(7, "Fortmon", TipoBicho.CHOCOLATE, 1050, 99, 5000, "/image/fortmon.jpg"));
        this.testService.crearEntidad(new Especie(8, "Dientemon", TipoBicho.AGUA, 1050, 99, 5000, "/image/dientmon.jpg"));
    }
